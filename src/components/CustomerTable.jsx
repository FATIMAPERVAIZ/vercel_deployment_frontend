...
//     try {
//       await fetch(`http://localhost:8080/users/deleteCustomer/${customerToDelete.customerId}`, {
//           method: "DELETE",
//       });
...
const CustomerTable = ({ customers, onRefresh }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/users/updateCustomerById/${editingCustomer}`, {
        method: "PUT",
